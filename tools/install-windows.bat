...
powershell -Command "[Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls12; Invoke-WebRequest https://tinytex.yihui.org/tinytex.profile -OutFile tinytex.profile" || exit /b
...
powershell -Command "[Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls12; Invoke-WebRequest https://tinytex.yihui.org/pkgs-custom.txt -OutFile pkgs-custom.txt"
