...
<!--
Welcome to the tinytex GitHub repo !
...
- [ ] pasted the output from `xfun::session_info('tinytex')` in your issue?

- [ ] upgraded all your packages to their latest versions (including your versions of R, the RStudio IDE, and relevant R packages)?

- [ ] installed and tested your bug with the development version of the tinytex package using `remotes::install_github("rstudio/tinytex")` ?
